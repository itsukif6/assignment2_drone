...
def generate_launch_description():
    nsysu_drone_bringup_path = get_package_share_directory('nsysu_drone_bringup')

    rviz_path = os.path.join(
        nsysu_drone_bringup_path, "rviz", "rviz.rviz"
    )
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(nsysu_drone_bringup_path, 'launch', 'nsysu_drone_gazebo.launch.py')
            )
        ),
